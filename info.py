...
API_ID = int(environ.get('API_ID', '22661813'))
API_HASH = environ.get('API_HASH', 'b8bdd0f7ca34c25ae62e8e03458c985c')
BOT_TOKEN = environ.get('BOT_TOKEN', "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")
